...
<body>
    <div class="">
        <!-- header -->
        <div class="bg-blue-100 text-center p-1 text-xl text-white">CLASS RANK</div>
        <!-- main -->
        <div class="flex">
            <!-- sidebar -->
            <div class="basis-1/4 p-2">
                <div class="bg-blue-100 m-3 p-4 rounded-lg">
            ...
            <div class="basis-3/4 p-2">
                <div class="bg-blue-100 p-3 m-3 rounded-lg">DATA RANKS BANG
                    <div class="">
                        <table class="w-full">
                            <thead class="text-center border border-white-800 bg-gray-800 text-white">
                                <tr>
